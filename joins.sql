...
FROM lost_dog_collars FULL OUTER JOIN dog_owners ON lost_dog_collars.dog_name = dog_owners.dog_name;

#2 Display collars for which there is no known owner
SELECT lost_dog_collars.id AS dog_collar_id, lost_dog_collars.dog_name, dog_owners.name AS owner_name
FROM lost_dog_collars LEFT JOIN dog_owners ON lost_dog_collars.dog_name = dog_owners.dog_name
...
FROM dog_owners LEFT JOIN lost_dog_collars ON lost_dog_collars.dog_name = dog_owners.dog_name;
